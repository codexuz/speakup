<template>
  <ion-page>
    <ion-header class="ion-no-border">
      <ion-toolbar mode="ios">
        <ion-buttons slot="start">
          <ion-back-button default-href="/speaking-practice/part-2"></ion-back-button>
        </ion-buttons>
    ...
    <ion-content class="ion-padding">
      ...
      <div v-else-if="question" class="question-container">
        ...
        <div v-if="activeTab === 'practice'">
          ...
          <div class="preparation-timer mb-4" v-if="showPrepTimer">
            <div class="text-center mb-2">
              <strong>Preparation Time:</strong> {{ formatTime(prepTime) }}
            </div>
            <ion-progress-bar :value="prepTime / 60"></ion-progress-bar>
          </div>
          ...
          <ion-accordion-group>
            ...
            <ion-accordion value="tips">
              ...
              <div slot="content" class="ion-padding">
                ...
                <div v-else>
                  <h3 class="font-medium mb-2">Part 2 Speaking Tips:</h3>
                  <ul class="list-disc pl-5 space-y-2">
                    <li>Use all your preparation time to make notes</li>
                    <li>
                      Structure your talk with an introduction, main points, and
                      conclusion
                    </li>
                    <li>
                      Include specific details and examples to illustrate your
                      points
                    </li>
                    <li>
                      Don't try to memorize a script - use your notes as a guide
                    </li>
                    <li>Try to speak for the full 2 minutes</li>
                    <li>
      ...
      <div v-else class="flex flex-col items-center justify-center h-full">
        ...
        <ion-button class="mt-4" router-link="/speaking/part-2">
          Back to Questions
        </ion-button>
      </div>
    </ion-content>
    ...
    <div
      v-if="activeTab === 'practice' && canRecord"
      class="recording-btn-container"
    >
      <ion-button
...
// Part 2 specific variables - preparation time
const prepTime = ref(60); // 1 minute prep time
const prepTimerInterval = ref(null);
const showPrepTimer = ref(false);
...
const startPrepTime = () => {
  ...
  showPrepTimer.value = true;
  prepTime.value = 60; // 1 minute in seconds

  prepTimerInterval.value = setInterval(() => {
    if (prepTime.value > 0) {
      prepTime.value--;
    } else {
      clearInterval(prepTimerInterval.value);
      showPrepTimer.value = false;
...
const startNewRecording = async () => {
  try {
    ...
    timerInterval.value = setInterval(() => {
      ...
      // Auto-stop after 2 minutes (typical for IELTS part 2)
