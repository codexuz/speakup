    ...
    <ion-header class="ion-no-border">
      <ion-toolbar mode="ios">
        <ion-buttons slot="start">
          <ion-back-button default-href="/speaking-practice/part-3"></ion-back-button>
        </ion-buttons>
    ...
    <ion-content class="ion-padding" :fullscreen="true">
      ...
      <div v-else-if="question" class="question-container">
        ...
        <div v-if="activeTab === 'practice'">
          ...
          <div class="topic-tags mb-4" v-if="question.topic">
            <ion-chip color="tertiary">
              <ion-icon :icon="pricetagOutline"></ion-icon>
              <ion-label>{{ question.topic }}</ion-label>
            </ion-chip>
          </div>

          <div
            class="question-content text-sm mb-5"
          ...
          <ion-accordion-group>
            ...
            <ion-accordion value="tips">
              ...
              <div slot="content" class="ion-padding">
                ...
                <div v-else>
                  <h3 class="font-medium mb-2">Part 3 Speaking Tips:</h3>
                  <ul class="list-disc pl-5 space-y-2">
                    <li>Give extended, detailed answers (not just yes/no)</li>
                    <li>Express and justify your opinions</li>
                    <li>
                      Use complex sentence structures and academic vocabulary
                    </li>
                    <li>Consider both sides of an argument when appropriate</li>
            ...
            <ion-accordion value="vocabulary">
              <ion-item slot="header" color="light">
                <ion-label>Useful Vocabulary</ion-label>
              </ion-item>
              <div slot="content" class="ion-padding">
                <div
                  v-if="question.vocabulary"
                  v-html="question.vocabulary"
                ></div>
                <div v-else>
                  <h3 class="font-medium mb-2">Expression Examples:</h3>
                  <ul class="list-disc pl-5 space-y-2">
                    <li>In my opinion...</li>
                    ...
                    <li>That's an interesting question because...</li>
                  </ul>
                </div>
              </div>
            </ion-accordion>
      ...
      <div v-else class="flex flex-col items-center justify-center h-full">
        ...
        <ion-button class="mt-4" router-link="/speaking/part-3">
          Back to Questions
        </ion-button>
      </div>
    </ion-content>
...
const startNewRecording = async () => {
  try {
    ...
    timerInterval.value = setInterval(() => {
      ...
      // Auto-stop after 1 minute (typical for one part 3 question)
