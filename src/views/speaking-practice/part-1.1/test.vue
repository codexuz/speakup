  ...
  <ion-page>
    <ion-header class="ion-no-border">
      <ion-toolbar mode="ios">
        <ion-buttons slot="start">
          <ion-back-button default-href="/speaking-practice/part-1.1"></ion-back-button>
        </ion-buttons>
    ...
    <ion-content class="ion-padding" :fullscreen="true">
      ...
      <div v-else class="flex flex-col items-center justify-center h-full">
        ...
        <ion-button class="mt-4" router-link="/speaking/part-1.1">
          Back to Questions
        </ion-button>
      </div>
    </ion-content>

    <!-- Removed bottom tab bar -->
  ...
  try {
    ...
    reader.onloadend = async function () {
      ...
      const savedFile = await Filesystem.writeFile({
        path: fileName,
        data: base64Data,
        directory: Directory.Data, // Changed from Documents to Data
        recursive: true,
      });
