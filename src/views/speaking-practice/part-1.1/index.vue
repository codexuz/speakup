  ...
  <ion-page>
    <ion-header class="ion-no-border">
      <ion-toolbar mode="ios">
        ...
        <ion-title>Speaking Part 1.1</ion-title>
      </ion-toolbar>
    </ion-header>

    <ion-content class="ion-padding">
      <div class="speaking-intro">
        <h2 class="text-xl font-bold mb-2">IELTS Speaking Part 1.1</h2>
        <p class="text-gray-700 mb-4">
          Introduction and interview questions. These are common questions the
          examiner might ask about yourself and familiar topics.
        </p>
      </div>
          ...
          <ion-col size="12" size-md="8" size-lg="8" class="mx-auto">
            ...
            <div class="questions-grid mt-8">
              <div 
                ...
                @click="router.push(`/speaking-practice/part-1.1/${question.id}`)"
              >
...
// Fetch part 1.1 questions
onMounted(async () => {
  try {
    loading.value = true;
    const response = await endpoints.speaking.getPart1();
